...
public interface ReportMatchSourceEntityMapper {
    ...
    */
     ...
     * @return
     */
    int enrolmentCount(@Param(value = "startTime") String startTime,
     ...
     * @return
     */
    int finishMatchCount(@Param(value = "startTime") String startTime,
                         @Param(value = "endTime") String endTime);
     ...
     * @return
     */
    List<ReportMatchSourceEntity> countMatchEnrollByParams(@Param(value = "matchCode") String matchCode,
