...
public interface ReportMatchSourceService {
     ...
     * @return
     */
    int enrolmentCount(String startTime, String endTime);
     ...
     * @return
     */
    int finishMatchCount(String startTime, String endTime);
     ...
     * @return
     */
    List<Map<String, Object>> countMatchEnrollPerson(String startDate, String endDate,
                                                     String matchCode);
